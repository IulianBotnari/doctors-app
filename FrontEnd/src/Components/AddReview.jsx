...
const AddReview = () => {
    ...
    return (
        <div className="container border border-1 border-secondary rounded p-4 mt-4 shadow-lg add_reviews " style={{ cursor: isLoading ? "wait" : "default" }} >
            ...
            <form onSubmit={handleSubmit} className="d-flex flex-column gap-3" autoComplete='off'>
                ...
                }} type="submit" className="btn mt-3 ">Invia Recensione</button>
            </form>
        </div>
    );
};
