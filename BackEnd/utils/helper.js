...
const nameRegex = /^[A-Z][a-z]{3,}$/; // prevede una stringa composta da soli caratteri alfabetici, che accetta almeno 3 caratteri di cui il primo deve essere maiuscolo.
